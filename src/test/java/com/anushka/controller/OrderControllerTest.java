...
public class OrderControllerTest extends AbstractAnushkaDataSetup {
    ...
    public void orderController_returnsJsonForAllOrdersByCustomerId() throws Exception {
        ...
        mockMvc.perform(get("/orders/getOrderDetailsForCustomerById?id=" + customerId.toString()))
                ...
                .andExpect(jsonPath("$..customer.firstName", hasItem("Anushka")))
                ...
                .andExpect(jsonPath("$.[2].productsOrders.[0].product.productType", equalTo("LILLY")))
                .andExpect(jsonPath("$.[2].productsOrders.[0].product.productName", equalTo("Easter Lilly")))
